...
var currentuserName = getUserInfo("username");
var currentuserEmail = getUserInfo("email");
const Header = ({ classes, isSidebarOpened, toggleSidebar, ...props }) => (
  <AppBar position="fixed" className={classes.appBar}>
    <Toolbar className={classes.toolbar}>
      ...
      <Typography variant="h6" weight="medium" className={classes.logotype}>Admin Panel</Typography>
